          ...
          <Grid item xs={8}>
            <div className="about-me-text">
              <p>
                ...
                perfectly aligned and visually consistent. My problem sovling skills rely very much on
                logical thinking, patience and solution-oriented approach. I like to break
                down a complex problem into smaller pieces and manage to tackle
                every step.
              </p>
              <br />
              <p>
